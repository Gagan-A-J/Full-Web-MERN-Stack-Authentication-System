...
exports.login = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ message: "OTP sent to your phone", phone: user.phone });
...
exports.reqresetpassword = async (req, res) => {
  ...
  try {
    ...
    await sendResetEmail(
      user.email,
      `Hi ${user.username}`,
      `<h1>Password Reset Link</h1><br><p>You requested to reset your password. Please click the button below to reset it:</p><br><a href="${link}">Reset Password</a>`,
    ); // Replace with actual email service in prod
